							...
							props.job.data
								...
								.map((v, i) => (
									<Fragment>
										...
										{/* {console.log(!props.category.data ? '' : typeof props.category.data.filter(i => i.name === v.categories)[0])} */}
										{!props.category.data ? (
											''
										) : (
											<div className="form-group">
												...
												<select
													name="id_category"
													className="form-control"
													defaultValue={props.category.data.filter(i => i.name === v.categories).id}
										...
										<div className="form-group">
											...
											<textarea
												...
												onChange={e => setDescription(e.target.value || v.description)}></textarea>
										</div>
										<div className="form-group">
											<label>Company</label>
											<select
